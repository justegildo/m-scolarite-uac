...
import { MentionService } from '../../_services/mention.service';
...
const Mention = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log(data);
        MentionService.addDomaine(data)
            .then(response => {
                console.log(response)
    ...
    const editItem = (item) => {
        ...
        MentionService.updateMention(updatedData)
            .then(response => {
                console.log(response);
            })
            .catch(error => {
    ...
    const deleteItem = (item) => {
        console.log(item);
        MentionService.deleteMention(item)
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0 font-size-18">Mention</h4>

                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><Link to="/dashboard">Accueil</Link></li>
                                        <li className="breadcrumb-item active">Mention</li>
                                    </ol>
                                </div>
                        ...
                        <div className='col-12'>
                            <div className="card">
                                <div className="card-body">
                                    <h4 className="card-title mb-4">Liste des Mentions</h4>
